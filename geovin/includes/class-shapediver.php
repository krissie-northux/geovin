...
class Shapediver {
    ...
    public function shapediver_controls_html() {
        ...
        if ( array_key_exists( 'pa_dimensions', $attributes ) && $attributes['pa_dimensions']->get_visible() ) {
            ...
            $markup .= '<div class="sd-control sd-control--dimensions" data-control="dimensions"><div class="sd-control__title">'. esc_html( $label ).'' . esc_html( $units_toggle ) . '</div><div class="sd-control__selected-value"></div><div class="sd-control__choices"></div></div>';
        }
